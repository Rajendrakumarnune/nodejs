'use strict';
//const PAGE_ACCESS_TOKEN = 'EAACHAnI1XQUBACqWkGhqU6P5u9Nz3XSDI7pu41aQNOD7a3UFCbsdJJ9kEeRqzxZCSD2kqYoAjsfTQ9Uhfv3DEytoZB6nDVweorvZClswHvqOU9mXpzNfCWZBNZAjVZB4P0en9ue36MFXIkK94TBdr8ivrxdaR0bLrgJXSaIysMSwZDZD';
const PAGE_ACCESS_TOKEN = 'EAAIsW1CX79wBAKh3AiPbjYYYVJ5HCQTLium6XlwUikhAXiO4roUGemm7iCZCJMQ5SXWoRGGwlp0YMji23NrM98e7ZCYUVwG8ZAyUd6ZC7kzt0krZCJhhTDZA4WbiTZBQIkAPwAHgBcpi2J517l4VPNWDtQU30h6DyuNAaBuobzk0QZDZD';
...
const apiaiApp = apiai('f0674d6d388749a28c5e476f4c823d73');
   ...
   if (req.body.result.action === 'busarrivaltime') {
     ...
     let busstop = req.body.result.parameters['BusStopNo'];
      ...
      request({
                uri: restUrl,
                method: 'GET',
                headers: {'AccountKey': 'c3f4e8dcef144e11927a0a45cfd85c7c'}
                 }, (err, response, body) => {
